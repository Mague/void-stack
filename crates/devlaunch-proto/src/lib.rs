pub mod pb {
    tonic::include_proto!("devlaunch");
}

pub mod client;

// Re-export for convenience
pub use pb::dev_launch_client::DevLaunchClient;
pub use pb::dev_launch_server::{DevLaunch, DevLaunchServer};

// --- Conversions between core types and protobuf types ---

use devlaunch_core::model::{ServiceState as CoreState, ServiceStatus as CoreStatus};
